...
<section class="section-content mb-2">
    <div class="container">
        ...
        <div class="row item-grid">
            <c:forEach var="category" items="${categoryModels}">
                <div class="col-lg-3 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <a href="/view/category?categoryId=${category.id}" class="stretched-link">
...
<%--                            <img class="img-fluid" src="${productModels.imageName}">--%>
<%--                        </a>--%>
<%--                        <figcaption class="info-wrap mt-2">--%>
<%--                            <a href="#" class="title">${productModels.name}</a>--%>
<%--                            <div class="price mt-1 fw-bold">${productModels.price}₫</div>--%>
<%--                        </figcaption>--%>
<%--                    </div>--%>
<%--                </div> <!-- col.// -->--%>
