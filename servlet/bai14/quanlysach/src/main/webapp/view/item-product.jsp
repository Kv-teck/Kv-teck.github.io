    ...
    <div class="container">
        <div class="row">
                ...
                <div id="productImageCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="${selectedProduct.imageName}" class="d-block w-100" alt="...">
                        </div>
            ...
            <main class="col-md-7 col-lg-6">
                    <h2 class="title">${selectedProduct.name}</h2>
                    ...
                    <div class="mb-4">
                        <span class="price h4">${selectedProduct.price}đ</span>
                        <span class="ms-2 text-muted text-decoration-line-through">20.000₫</span>
                    </div>

                    <dl class="row mb-4">
                        <dt class="col-xl-4 col-sm-5 col-6">Nhà xuất bản</dt>
                        <dd class="col-xl-8 col-sm-7 col-6"><a href="#">${selectedProduct.pages}</a></dd>
                        ...
                        <dd class="col-xl-8 col-sm-7 col-6">
                            <input type="number" class="form-control w-50" value="1" min="1" max="1000" step="1"/>
                        </dd>
                    </dl>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <p>${selectedProduct.yearPublishing}
                    </p>
                </div>
            </div>
        </div>
